...
export const createControls = (sky) => {
  ...
  const sliders = [
    ...
    },
    {
      ...
      step: 5,
      skipRandomize: true,
      format: (value) => (value > 0 ? `${Math.round(value)} fps` : "off"),
    },
    {
      key: "bandWeight",
  ...
  const toggleRows = [
    ...
    { key: "nebulaEnabled", label: "Enable nebulae" },
    { key: "milkyWayEnabled", label: "Enable milky way" },
    { key: "auroraEnabled", label: "Enable aurora" },
    { key: "diffractionSpikesEnabled", label: "Enable diffraction spikes" },
    { key: "fisheyeEnabled", label: "Fisheye projection" },
    { key: "sizeVariationEnabled", label: "Enable size variation" },
    { key: "depthParallaxEnabled", label: "Depth parallax" },
    { key: "cameraDriftEnabled", label: "Camera idle drift" },
    ...
    { key: "satellitesEnabled", label: "Enable satellites" },
    { key: "adaptiveQualityEnabled", label: "Adaptive quality" },
  ].map((toggle) =>
    createToggleRow({
      config: sky.config,
      key: toggle.key,
